...
% (DLF EDIT: when n<0.5, output is not dependent on n)
% (remove edits to code to restore original function)
...
%     DLF EDit July - 17 - 2014
    %%% This disregards the use of 'n' entirely
