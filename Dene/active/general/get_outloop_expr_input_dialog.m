function get_outloop_expr_input_dialog(start_expr,calling_fig,calling_fig_handles)
if nargin < 1
    start_expr = '';
end

d = dialog('Position',[300 300 500 500],'Name','(Outside Loop) Input Expression');
...
handles.txtH = uicontrol('Parent',d,...
       ...
       'String','(Outside Loop) Input Expression');
...
cmapDB.outside_loop_expr = expr_input;
set(calling_fig_handles.outloop_expr_input_staticH,'string',expr_input);
