function visualize_rotating_edge_data_bestfit(ang,len,channel_info,dv_to_ap,dv_to_ap_times,...
                                              timestep,save_dir,savename,extratxt)
...
twocolors = [[0.8 0 0];[0 0.75 0]];
for i = 1:length(channel_info)
    tempmean = aligned_levels(i).bestfit;
    tempderiv = deriv(tempmean);
...
xticktxt = num2str(ceil(((xtickmarks - timelen)*timestep/60)'));
...
bname = [save_dir, filesep,[savename,'-rot-v-time-bestfit']];
